...
import 'package:projetsalon/client-fournisseurs/clients/ui/listview_note.dart';
import 'package:projetsalon/client-fournisseurs/fournisseurs/ui/listview_note.dart';
...
class Collaborateurs extends StatefulWidget {
 
 
  @override
  _CollaborateursState createState() => _CollaborateursState();
}

class _CollaborateursState extends State<Collaborateurs> {
          ...
          child: Scaffold(
           key: _scaffoldKey,
            ...
            onPressed: () => _scaffoldKey.currentState.openDrawer()),
              title:Text('Clients-fournisseurs',style: TextStyle(color: Colors.black, fontSize: 17),),
              backgroundColor: Colors.white,
              bottom: TabBar(
                labelColor: Colors.black,
                labelStyle: TextStyle(fontSize: 14),
                tabs: [
                  Tab(icon: Icon(FontAwesomeIcons.productHunt), text: 'Clients'),
                  Tab(icon: Icon(Icons.directions_transit), text: "Fournisseurs"),
                ],
              ),
            ),
              drawer:Container(
