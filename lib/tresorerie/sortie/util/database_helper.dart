...
//    await deleteDatabase(path); // just for testing
  ...
  void _onCreate(Database db, int newVersion) async {
    await db.execute(
        'CREATE TABLE $tableNote($columnId INTEGER PRIMARY KEY, $ColumnNom TEXT, $ColumnQte TEXT, $columnDetails TEXT, $columnPrixAchat TEXT, $columnDateAjout TEXT)');
  }
...
//        'INSERT INTO $tableNote ($ColumnNom, $ColumnQte) VALUES (\'${note.title}\', \'${note.description}\')');
  ...
  Future<List> getAllNotes() async {
    var dbClient = await db;
    var result = await dbClient.query(tableNote, columns: [columnId, ColumnNom, ColumnQte, columnPrixAchat,columnDateAjout]);
