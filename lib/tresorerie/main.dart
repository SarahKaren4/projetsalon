...
import 'package:projetsalon/tresorerie/entree/ui/listview_note.dart';
import 'package:projetsalon/tresorerie/sortie/ui/listview_note.dart';

class Tresorerie extends StatefulWidget {
 
 
  @override
  _TresorerieState createState() => _TresorerieState();
}

class _TresorerieState extends State<Tresorerie> {
          ...
          child: Scaffold(
           key: _scaffoldKey,
            ...
            onPressed: () => _scaffoldKey.currentState.openDrawer()),
              title:Text('Trésorerie',style: TextStyle(color: Colors.black, fontSize: 17),),
              backgroundColor: Colors.white,
              bottom: TabBar(
                labelColor: Colors.black,
                labelStyle: TextStyle(fontSize: 14),
                tabs: [
                  Tab(icon: Icon(FontAwesomeIcons.productHunt), text: 'Entrées'),
                  Tab(icon: Icon(Icons.directions_transit), text: "Sorties"),
                ],
              ),
            ),
              drawer:Container(
