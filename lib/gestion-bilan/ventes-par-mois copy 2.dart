...
class VentesParMois extends StatefulWidget {
  String numero;
  VentesParMois({this.numero});
  @override
  _VentesParMoisState createState() => new _VentesParMoisState();
}

class _VentesParMoisState extends State<VentesParMois> {
  String now ='';
