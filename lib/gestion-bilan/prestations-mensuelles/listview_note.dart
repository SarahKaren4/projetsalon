...
class PrestationMoisActuel extends StatefulWidget {
  @override
  _PrestationMoisActuelState createState() => new _PrestationMoisActuelState();
}
class _PrestationMoisActuelState extends State<PrestationMoisActuel> {
            ...
            Container(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text('Prestations de ${mois}'),
                ),
                Expanded(
                              ...
                              InkWell(
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    Html(
                                      data: """
                       <table border='1'><tr><th>${items[position].nomprestation}</th><th>${items[position].cout}<br>Francs Cfa</th><th>${items[position].nomclient}</th></tr></tr></table>
  """, ),
