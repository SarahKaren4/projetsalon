...
class ChooseMonthDepense extends StatefulWidget {
  String numero;
  ChooseMonthDepense({this.numero});
  @override
  _ChooseMonthDepenseState createState() => new _ChooseMonthDepenseState();
}

class _ChooseMonthDepenseState extends State<ChooseMonthDepense> {
  String now ='';
