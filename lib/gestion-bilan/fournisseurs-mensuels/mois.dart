...
import 'package:projetsalon/gestion-bilan/bilan-depenses.dart';
...
class ChooseMonthFournisseur extends StatefulWidget {
  String numero;
  ChooseMonthFournisseur({this.numero});
  @override
  _ChooseMonthFournisseurState createState() => new _ChooseMonthFournisseurState();
}

class _ChooseMonthFournisseurState extends State<ChooseMonthFournisseur> {
  String now ='';
          ...
          child: ListView(
            ...
            children: <Widget>[
                ...
                Card(
                          ...
                          onTap: () {
                            Route route = MaterialPageRoute(builder: (context) => BilanMensuelDepense());
                    Navigator.push(context, route);
