...
class ListViewVenteJour extends StatefulWidget {
  @override
  _ListViewVenteJourState createState() => new _ListViewVenteJourState();
}

class _ListViewVenteJourState extends State<ListViewVenteJour> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text( 'Ventes' , style: TextStyle(
        ...
        body: Column(
          children: <Widget>[
            Padding(
              ...
              child: Text ('Ventes du $now', style: TextStyle(fontWeight: FontWeight.w900, ),),
            ),
            Html(
              data: """
                       <table border='1'><tr><th>Nom</th><th>Quantité</th><th>Total</th></tr></tr></table>
  """, ),
            Expanded(
              child: ListView.builder(
                  itemCount: items.length,
                        ...
                        InkWell(
                          child: Column(
                            children: <Widget>[
                              ...
                              Html(
                                data: """
                       <table border='1'><tr><th>${items[position].nom}</th><th>${items[position].qte}</th><th>${items[position].couttotal}<br>Francs Cfa</th></tr></tr></table>
  """, ),
